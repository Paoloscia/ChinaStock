...
palestra::palestra(string n, string c, int a, int m, int g,string cf, string lN, string r, string v, unsigned int num,string nt,string em,bool s,bool sc,string ni,int sapa,int smpa,int sgpa):cliente(n,c,a,m,g,cf,lN,r,v,num,nt,em,s),scheda(sc),nomeistruttorepalestra(ni),scadenzapalestra(sapa,smpa,sgpa){}
